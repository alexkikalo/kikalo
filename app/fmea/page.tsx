    ...
    <main className="min-h-screen bg-zinc-950 text-white selection:bg-cyan-500/30">
      ...
      <section className="relative flex min-h-[80vh] flex-col items-center justify-center px-6 py-20 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-3xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-1.5 text-xs tracking-[2px] text-cyan-400 mb-8">
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-14 text-left">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-5">
              <ShieldCheck className="h-5 w-5 text-cyan-400 mb-3" />
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-5">
              <FileSpreadsheet className="h-5 w-5 text-cyan-400 mb-3" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center justify-center rounded-2xl bg-cyan-500 px-8 py-3.5 text-sm font-semibold text-zinc-950 transition hover:bg-cyan-400 active:scale-[0.98]"
            >
